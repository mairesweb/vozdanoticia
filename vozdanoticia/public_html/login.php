                ...
                <div class="ui-body ui-body-a">
                    <form method="post" action="login.php" data-ajax="false">
                        <div class="ui-field-contain">
                            ...
                            <input type="text" name="usuario" maxlength="50" id="usuario" required="required" placeholder="Digite seu usuário" value="">
                        </div>
                        <div class="ui-field-contain">
                            <label for="senha">Senha:</label>
                            <input type="password" name="senha" maxlength="50" id="senha" required="required" placeholder="Digite sua senha" value="">
                        </div>
